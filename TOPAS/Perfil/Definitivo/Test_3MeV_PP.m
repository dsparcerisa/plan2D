clear all
close all
EdepFileName = 'Edep_3MeV_PP.csv';
Edep_STDFileName = 'Edep_STD_3MeV_PP.csv';
CodeFileName = 'Test_3MeV_PP.txt';
...
[z_exp,sigmaX_exp,sigmaY_exp,nlm_exp_X,nlm_exp_Y] = Exp_3MeV_PP_R14_06022020;
