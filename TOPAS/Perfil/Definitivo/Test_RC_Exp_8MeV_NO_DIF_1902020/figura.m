function figura(z_exp,sigmaX_exp,sigmaY_exp,poly_exp_X,poly_exp_Y,sigmaX,sigmaY,polyX,polyY,COMGX,numbfig,numbsubfig);
%%
%%
zz = [4.5:0.1:13];
...
hold on
plot(zz,polyval(poly_exp_X,zz),'m--','MarkerSize',5)
hold on
%Sim Sigma X
...
hold on
plot(zz,polyval(poly_exp_Y,zz),'c--','MarkerSize',5)
hold on
%Sim Sigma Y
