...
[SEdep,SEdep_weighted,NR,NZ,dR,dZ,spreadX,spreadY,angularspreadX,angularspreadY,energy,N_histories] = loadEdep_Q(SimulationNumber);
%%
...
Zo = 2; %HAY QUE DESPLAZAR EL SCORER XQ NO EMPIEZA A LA SALIDA DEL HAZ!!!!!!!
ZMaxValues = dZ * (1:NZ);
