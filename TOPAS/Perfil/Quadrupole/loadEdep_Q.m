function [SEdep,SEdep_weighted,NR,NZ,dR,dZ,spreadX,spreadY,angularspreadX,angularspreadY,energy,N_histories] = loadEdep_Q(SimulationNumber)
% Creates polinomial fit for sigma based on fluence and deposited energy
% in files within folder

%% Prepare file names
EdepFileName = 'Edep_Q.csv';
Edep_STDFileName = 'Edep_STD_Q.csv';
SDFileName = 'SIN_DIFUSOR_Q.txt';
