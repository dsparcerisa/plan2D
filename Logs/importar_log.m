function  tbl_Datos=importar_log(filename)
...
tbl_Datos.Properties.VariableNames = {'Numero_exposiciones','Tiempo_apertura_teorico_s','Apertura_s','Cierre_s','XYZ_inicial_cm','Tiempo_posicion_inicial_s','XYZ_final_cm','Tiempo_posicion_final_s'}    